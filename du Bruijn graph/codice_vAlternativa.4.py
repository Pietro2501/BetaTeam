...
dict_filtered_f = dict_filter(dict_fastq_f)
seq_filtered_f = [dict_filtered_f[key]["seq"] for key in dict_filtered_f.keys()]

file_r= t.extract_info(r"PhoeVulATCC8482_R2.fq.gz")
dict_fastq_r= parse_fastq(file_r)
dict_filtered_r = dict_filter(dict_fastq_r)
seq_filtered_r = [dict_filtered_r[key]["seq"] for key in dict_filtered_r.keys()]
